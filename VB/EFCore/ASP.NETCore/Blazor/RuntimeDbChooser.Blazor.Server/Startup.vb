    ...
    Public Class Startup
        ...
        Public Sub ConfigureServices(ByVal services As IServiceCollection)
            ...
            services.AddXaf(Configuration, Function(builder)
                ...
                builder.Modules.AddConditionalAppearance().AddReports(Function(options)
                    options.EnableInplaceReports = True
                    options.ReportDataType = GetType(DevExpress.Persistent.BaseImpl.EF.ReportDataV2)
                    options.ReportStoreMode = DevExpress.ExpressApp.ReportsV2.ReportStoreModes.XML
                End Function).AddValidation().Add(Of [Module].RuntimeDbChooserModule)().Add(Of RuntimeDbChooserBlazorModule)()
                builder.ObjectSpaceProviders.AddSecuredEFCore().WithDbContext(Of [Module].BusinessObjects.DemoDbContext)(Function(serviceProvider, options)
