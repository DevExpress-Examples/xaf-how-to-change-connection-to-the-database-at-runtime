...
'''  End Function)
            ...
            If ObjectSpace.Database.Contains("DB1") Then
                Dim sampleUser1 As ApplicationUser = ObjectSpace.FirstOrDefault(Of ApplicationUser)(Function(u)
                     ''' Cannot convert BinaryExpressionSyntax, System.NullReferenceException: Object reference not set to an instance of an object.
'''    at ICSharpCode.CodeConverter.VB.NodesVisitor.VisitBinaryExpression(BinaryExpressionSyntax node)
'''    at Microsoft.CodeAnalysis.CSharp.CSharpSyntaxVisitor`1.Visit(SyntaxNode node)
'''    at ICSharpCode.CodeConverter.VB.CommentConvertingVisitorWrapper`1.Accept(SyntaxNode csNode, Boolean addSourceMapping)
...
'''  End Function)
            ...
            If ObjectSpace.Database.Contains("DB2") Then
                Dim sampleUser2 As ApplicationUser = ObjectSpace.FirstOrDefault(Of ApplicationUser)(Function(u)
                     ''' Cannot convert BinaryExpressionSyntax, System.NullReferenceException: Object reference not set to an instance of an object.
'''    at ICSharpCode.CodeConverter.VB.NodesVisitor.VisitBinaryExpression(BinaryExpressionSyntax node)
'''    at Microsoft.CodeAnalysis.CSharp.CSharpSyntaxVisitor`1.Visit(SyntaxNode node)
'''    at ICSharpCode.CodeConverter.VB.CommentConvertingVisitorWrapper`1.Accept(SyntaxNode csNode, Boolean addSourceMapping)
...
'''  End Function)
        ...
        Private Function CreateDefaultRole() As PermissionPolicyRole
            ...
            If defaultRole Is Nothing Then
                ...
                defaultRole.AddObjectPermission(Of PermissionPolicyUser)(SecurityOperations.ReadOnlyAccess, "[ID] = CurrentUserId()", SecurityPermissionState.Allow)
