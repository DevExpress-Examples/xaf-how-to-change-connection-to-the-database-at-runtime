...
namespace RuntimeDbChooser.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf(Configuration, builder => {
                ...
                builder.ObjectSpaceProviders
                    .AddSecuredXpo((serviceProvider, options) => {
                        ...
                        options.ConnectionString = serviceProvider.GetRequiredService<IConnectionStringProvider>().GetConnectionString();
            ...
            services.AddSingleton<IConnectionStringHelper, ConnectionStringHelper>();
        }
